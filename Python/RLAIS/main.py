...
def prueba(n_groups,n_samples_mh,n_data):
    ...
    evaluation_all_matrix = np.zeros((n_samples_mh,n_groups))
    all_weights = []
...
if __name__ == "__main__":
    ...
    have to be changed"""
    fil = open("C:/Users/ErnestoAngelCurbeloB/Desktop/tfm_codes/códigos más claros/RLAIS/true values.txt","r")
    line = fil.readlines()
    values = line[2].split("  ")
    Z,mu1,mu2,var1,var2 = values
    Z_true,mu1_true,mu2_true,var1_true,var2_true = float(Z),float(mu1),float(mu2),float(var1),float(var2)
    
    x_observed = np.loadtxt("C:/Users/ErnestoAngelCurbeloB/Desktop/tfm_codes/códigos más claros/RLAIS/x_observed.txt")
    data_with_error_observed = np.loadtxt("C:/Users/ErnestoAngelCurbeloB/Desktop/tfm_codes/códigos más claros/RLAIS/data_with_error_observed.txt")
    ...
    folder_address = "C:/Users/ecurbelo/Desktop/trabajo con luca/rlais/Simulaciones"
