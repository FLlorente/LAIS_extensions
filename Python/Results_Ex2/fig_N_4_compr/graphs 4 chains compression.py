...
for par in parameters:
    ...
    ham_aux = data_no_compression[(data_no_compression["Parameters"]==par)&(data_no_compression["Algorithm"]=="HAM")&(data_no_compression["Epochs"]==600)]
    ...
    fig.savefig(f"imagenes/{par}, 4 cadenas.png",bbox_inches="tight")
